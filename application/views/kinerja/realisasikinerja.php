            ...
            <div class="card shadow mb-12">
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                    <a href="<?= base_url('Kinerja/tambahrealisasi'); ?>" class="btn btn-info"><i class="fa fa-plus" style="padding-right: 5px"></i>Tambah File</a>
                  ...
                  <table id="datatable-buttons" class="table table-striped table-bordered" >
                    ...
                    <tbody>
                      ...
                      <tr>
                         ...
                         <td><?= $nf['nama_file']; ?></td>
                         <td><?= $nf['file']; ?></td> 
                         <td><a href="<?= base_url(); ?>Kinerja/lihatrealisasi/<?= $nf['id'] ?>" class="badge badge-info float-right" >Lihat</a></td>
                         <td><a href="<?= base_url(); ?>Kinerja/hapusrealisasi/<?= $nf['id'] ?>" class="badge badge-info float-right" onclick="return confirm('Yakin ingin menghapus file?');">Hapus</a></td>
